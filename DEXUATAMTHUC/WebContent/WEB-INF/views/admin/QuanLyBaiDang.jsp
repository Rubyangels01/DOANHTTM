                        ...
                        <li class="dropdown">
                            <button onclick="myFunction()" class="dropbtn">Danh Mục
                                ...
                                <div id="myDropdown" class="dropdown-content"> 
                                    ...
                                    <a href="Home.html">Tìm Kiếm Món Ăn</a>
                                    <a href="Home.html">Tìm Kiếm Món Ăn Theo Nguyên Liệu</a>
                                    <a href="#">Món Ăn Phổ Biến</a>
...
if (!event.target.matches('.dropbtn')) {
        ...
        <li class="dropdown">
            <button onclick="myFunction2()" class="dropbtn">Quản Lý
                <i class="fa fa-caret-down"></i>
                
                <div id="myDropdown2" class="dropdown-content">  <!--dropdown danh mục -->
        ...
        <script>
            ...
            window.onclick = function(event) {
                ...
                <button class="login-btn"><a href="DangNhap.html" ><i class="fa-solid fa-user"></i> Tài Khoản</a></button>
        </div>
    </header>
